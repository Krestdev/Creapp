                ...
                <TableBody>
                    {slicedItems.map((user, i) => (
                        <TableRow key={i} className="bg-white">
                            ...
                            <TableCell className="items-start font-normal" >{user.manager}</TableCell>
                            <TableCell className="items-start font-normal" >{user.department}</TableCell>
                            <TableCell className="items-start font-normal" >{user.member.length}</TableCell>
