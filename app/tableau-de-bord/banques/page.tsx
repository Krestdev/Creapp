...
function Page() {
  ...
  {
    title: "Solde Total",
    value: XAF.format(getBanks.data.data.reduce((sum, bank) => sum + bank.balance, 0)),
    variant: 'primary',
  },
  {
    title: "Comptes Bancaires",
    value: XAF.format(getBanks.data.data.filter(b => b.type === "BANK")
  ...
  {
    title: "Caisses",
    value: XAF.format(getBanks.data.data.filter(b => b.type === "CASH")
        .reduce((sum, bank) => sum + bank.balance, 0)),
    variant: "dark",
    more: {
      title: "Nombre de comptes",
  ...
  },
  {
    ...
    value: XAF.format(getBanks.data.data.filter(b => b.type === "MOBILE_WALLET")
        .reduce((sum, bank) => sum + bank.balance, 0)),
    variant: "default",
    more: {
      title: "Nombre de comptes",
      value: getBanks.data.data.filter(b => b.type === "MOBILE_WALLET").length,
    }
  },
];
    return (
