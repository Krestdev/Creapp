  ...
  if (
    ...
    const getTypeClassName = (
      ...
      switch (type) {
        case "achat":
          return {
            className: "border-sky-200 from-sky-50 to-sky-100 text-sky-500",
          };
        case "speciaux":
          return {
            className:
              "border-purple-200 from-purple-50 to-purple-100 text-purple-500",
          };
        case "facilitation":
          return {
            className: "border-lime-200 from-lime-50 to-lime-100 text-lime-600",
          };
        case "ressource_humaine":
          return {
            className:
              "border-orange-200 from-orange-50 to-orange-100 text-orange-500",
          };
        case "others":
          return {
            className: "border-gray-200 from-gray-50 to-gray-100 text-gray-800",
          };
        case "gas":
          return {
            className: "border-rose-200 from-rose-50 to-rose-100 text-rose-500",
          };
        case "transport":
          return {
            className:
        ...
        default:
          return {
            className: "border-gray-200 from-gray-50 to-gray-100 text-gray-500",
          };
      }
    };
        ...
        {!requestType ? (
          <>
            ...
            <div className="grid @min-[760px]:grid-cols-2 @min-[1080px]:grid-cols-3 @min-[1600px]:grid-cols-4 gap-3">
              {user?.role &&
                typesList(user.role).map(({ type, label, description }) => (
                  <div
                    key={type}
                    className={cn(
                      "flex flex-col gap-2 justify-between rounded border bg-linear-to-t p-6 cursor-pointer",
                      getTypeClassName(type).className,
                    )}
