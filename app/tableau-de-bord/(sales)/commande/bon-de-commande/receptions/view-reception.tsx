...
import { CalendarFold, CalendarIcon, CheckIcon, FileIcon, FileTextIcon, HelpCircle, LucideHash, ScrollText, SquareUser, XIcon } from "lucide-react";
        ...
        <div className="grid gap-4">
          <div className="view-group">
            ...
            <div className="view-group">
              ...
              <div className="flex flex-col">
                <p className="view-group-title">{reception.updatedAt ? "Mis à jour le" : "Créé le"}</p>
                <p className="font-semibold">
                  {format(new Date(reception.updatedAt || reception.createdAt), "dd MMMM yyyy", {locale: fr})}
                </p>
              </div>
            </div>
        </div>
