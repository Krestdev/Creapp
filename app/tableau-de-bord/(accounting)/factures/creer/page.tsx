...
function Page() {
  ...
  const toPay =
    ...
    purchase.netToPay -
      invoices
        .filter((i) => i.commandId === purchase.id && i.status !== "CANCELLED")
  ...
  if (getPurchases.error || getInvoices.isLoading)
    return (
      <ErrorPage error={getPurchases.error || getInvoices.error || undefined} />
    );
